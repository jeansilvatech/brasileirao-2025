                        ...
                        <div className="lg:w-[700px] w-3/4 flex lg:justify-start justify-center items-center flex-wrap">
                            {
                                teams.map((item:any, index:number)=>(
                                    <div key={index} data-name={`${item.name}`} className="animate-enter m-2 lg:p-2 border-[1px] border-transparent relative hover:border-[1px] hover:border-white/30 hover:bg-white/20 hover:backdrop-blur-3xl" title={item.name.toUpperCase()}>
